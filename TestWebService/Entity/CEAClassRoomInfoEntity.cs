...
{
    public class CEAClassRoomInfoEntity
    {
        #region Constructor
        public CEAClassRoomInfoEntity() { }

        public CEAClassRoomInfoEntity(Int32 classRoomID, String code, String name, String address, String type, Int32? seatNum, String remark, String valid, DateTime createTime, String createBy, DateTime updateTime, String updateBy)
        {
