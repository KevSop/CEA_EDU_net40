...
{
    public class CEAClassInfoEntity
    {
        #region Constructor
        public CEAClassInfoEntity() { }

        public CEAClassInfoEntity(Int32 classID, String code, String name, String type, DateTime? startTime, DateTime? endTime, String teacherCode, String company, String department, String remark, String valid, DateTime createTime, String createBy, DateTime updateTime, String updateBy)
        {
